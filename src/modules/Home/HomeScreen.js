...
<Image
          ...
          <Text style={{color: 'black',
              fontSize: 15,
              fontWeight: '600',marginLeft:15,}}>Total Item Count  (1000)</Text>
        </View>
        <View  style={{flexDirection:'row',height:80,borderRadius:20,backgroundColor:'white',marginTop:30,alignItems:'center'}}>
<Image
                  style={{
          ...
          <Text style={{color: 'black',
              fontSize: 15,
              fontWeight: '600',marginLeft:30}}>Item Count By Vendor  (40)</Text>
        </View>
        <View  style={{flexDirection:'row',height:80,borderRadius:20,backgroundColor:'white',marginTop:30,alignItems:'center'}}>
<Image
                  style={{
          ...
          <Text style={{color: 'black',
              fontSize: 15,
              fontWeight: '600',marginLeft:30}}>Item Count By Subcategory  (25)</Text>
        </View>
</View>
